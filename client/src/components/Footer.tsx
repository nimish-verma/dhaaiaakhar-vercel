  ...
  return (
    <footer ref={containerRef} className={`${bgColor} ${textColor} pt-32 pb-12 px-6 md:px-20 border-t ${borderColor}`}>
      <div className="flex flex-col items-center justify-center text-center mb-24">
        ...
        <a href="mailto:hello@dhaiaakar.com" className={`group relative overflow-hidden rounded-full border ${theme === "dark" ? "border-white/30" : "border-black/30"} bg-transparent px-12 py-4 text-lg uppercase tracking-widest transition-all hover:border-accent-rose hover:text-bg-deep cursor-pointer`}>
